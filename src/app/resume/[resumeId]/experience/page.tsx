...
export default function ExperiencePage() {
  ...
  useEffect(() => {
    if (resume?.workExperience) {
      reset({
        workExperience:
          resume.workExperience.length > 0 ? resume.workExperience : [],
      });
    }
  }, [resume, reset]);
  ...
  const addTechnology = (expIndex: number) => {
    ...
    if (!currentTechs.includes(tech)) {
      setValue(`workExperience.${expIndex}.technologies`, [
        ...currentTechs,
        tech,
      ]);
    }
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          {fields.map((field, index) => {
            const technologies =
              watch(`workExperience.${index}.technologies`) || [];
            return (
              <div
                key={field.id}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <AITextGenerate
                        ...
                        fields={[
                          ...
                          {
                            key: "technologies",
                            label: "Technologies you used there (comma-separated)",
                        ...
                        onApply={(text) =>
                          setValue(`workExperience.${index}.description`, text)
                        }
                      />
                    </div>
                    <textarea
