      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        {fields.length === 0 && (
          <div className="bg-white rounded-xl border border-dashed border-slate-300 p-12 text-center">
            ...
            <p className="text-sm text-slate-500 mb-4">Add your degrees, certifications, and courses</p>
          ...
          <div key={field.id} className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2 md:col-span-2">
                ...
                <Input {...register(`education.${index}.school`)} placeholder="Stanford University" />
                {errors.education?.[index]?.school && <p className="text-xs text-red-500">{errors.education[index]?.school?.message}</p>}
              </div>
